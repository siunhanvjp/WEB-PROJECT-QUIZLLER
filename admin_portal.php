...
<html>
	<head>
	    ...
	    <title>Quizzler-Admin Portal</title>
		<meta property="og:site_name" content="Quizller"/>
		<meta property="og:title" content="Admin Login page"/>
		<meta property="og:description" content="Admin login to website to manage teacher"/>
					...
					<div class="wrap-login100">
						...
						<div class="login100-form validate-form">
							...
							<div class="container-login100-form-btn">
								...
								<a href="index.php">Login as Teacher</a>
							</div>
		...
		<script>
			...
			function login() {
				...
				if (!someFieldIsEmpty) {
					$.ajax({
						type: 'POST',
						url: 'files/admin_checklogin.php',
						data: {
						...
						success: function (response) {
							if(response != "success"){
								...
								setTimeout(function(){
									window.location="files/admin_dashboard.php";
								},1200);
							}	
						}
					});
